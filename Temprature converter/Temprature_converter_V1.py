...
# conversion from base(celsius) to target_unit        
...
try:
    temp=float(input(Fore.YELLOW+"Enter the Temperature:"))
    unit=input(Fore.YELLOW+"Enter the unit of provided Temperature:").upper()
